const sendRemoveTeamMemberMail = function(details) {
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td style="
                                                                ...
                                                                <br>
                                                                Team ${details.name} is now full. Hence you have been removed from the waiting list. We suggest you to join another team or create a new team on your own through our portal by clicking the link below. </p>
                                                                    <a href="https://portal.ideathon.dscvit.com/login" style="background-color: #ffffff">portal.ideathon.dscvit.com/login</a>
                                                                <br>
                                                                <p style="color: #ffffff">
                                                                    We look forward to seeing your submission on our platform.
                                                                </p>
...
module.exports = sendRemoveTeamMemberMail;