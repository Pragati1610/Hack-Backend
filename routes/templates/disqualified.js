const disqualified = function(details) {
    return `<!DOCTYPE html
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="
                                            ...
                                            ">
                                        <b>Thank you for participating in Ideathon 2020</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td style="
                                                                ...
                                                                font-size: 15px;">Greetings from DSC VIT!

                                                                <br>
                                                                Thank you for participating and pitching your idea in Round 1. We appreciate your efforts and congratulate you for making it this far in the competition. We regret to inform you have not been shortlisted for the next round of Ideathon 2020. 
                                                                <br>
                                                                The livestream for the top 5 pitches will be held at 5 PM. Do join us using the link mentioned below.
                                                                <br>
                                                                <a href="https://youtu.be/JPlWt8lzpak" style="color: #FEA1BE">https://youtu.be/JPlWt8lzpaklogin</a>

                                                              </p>
                                                                <br>
                                                                    <p style="color: #ffffff; font-family: Roboto, sans-serif;
                                                                    font-size: 15px;">
                                                                    Keep your ideas alive by joining our outer circle on telegram <a href="https://bit.ly/DSCVITOuterCircle" style="color: #FEA1BE">https://bit.ly/DSCVITOuterCircle</a> for discussion and other updates about events and recruitments. 
                                                                    <br>
                                                                    
                                                                </p>
                                                                <br>
                                                                <p style="color: #ffffff; font-family: Roboto, sans-serif;
                                                                font-size: 15px;">Looking forward to your participation in our upcoming events. </p>
                                                                <br>
                                                                <p style="color: #ffffff; font-family: Roboto, sans-serif;
                                                                font-size: 15px;>Best Regards,</p>
                                                                <p style="color: #ffffff; font-family: Roboto, sans-serif;
